...
{
#if !defined(TARGET_WASI) && !defined(TARGET_LIBNX)  // the valid range of file descriptors is probably INT32_MIN <= fd && fd <= INT32_MAX, the negative handles are valid for console.
